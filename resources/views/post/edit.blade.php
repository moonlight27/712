            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="container_fluid" style="padding:0;">
                        <form style="margin-top:20px;" class="form-check form-check-inline" method="POST" action="{{ route('post.update',['id'=>$post->id]) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label for="content" class="col-sm-2 control-labbel">內文</label>
                                <div class="col-sm-10">
